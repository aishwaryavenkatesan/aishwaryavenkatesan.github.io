            ...
            <div class="flex md:contents">
              ...
              <div class="bg-blue-500 col-start-6 col-end-10 p-4 rounded-xl my-4 mr-auto shadow-md">
                ...
                <p class="leading-tight text-justify text-[15px]">
                  Created customer-facing REST APIs with Spring Boot and OAuth
                  for consumer cards, achieving a 70% increase in test coverage
                  using Junit and Mockito in alignment with partner requirements
                  for reward points redemption.Implemented microservices, set up
                  CI/CD pipelines in Jenkins, managed deployments on OpenShift,
                  and utilized AppDynamics for performance monitoring, leading
                  to streamlined operations and heightened application
                  ...
                  batch job, by conducting detailed analysis to identify the
                  root cause, modified database queries to ensure successful
                  batch execution. Collaborated with cross-functional teams in
                  an Agile environment to successfully deliver high-quality
                  projects within tight deadlines, adhering to software best
                  practices
                </p>
              </div>
            </div>
